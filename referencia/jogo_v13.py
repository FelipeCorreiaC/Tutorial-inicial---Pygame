...
boom_sound = pygame.mixer.Sound('referencia/assets/snd/expl3.wav')
destroy_sound = pygame.mixer.Sound('referencia/assets/snd/expl6.wav')
pew_sound = pygame.mixer.Sound('referencia/assets/snd/pew.wav')
